---
title: "The Agent Space: An Overview (paradigms)"
url:
date: 2026-04-12
...
> *paradigms* — April 12, 2026

i fell into the ai agent space 4 months back when i fell in with an ecosystem of thought leaders, forward looking builders and early adopters. being completely non-technical, i started by quitely observing this ecosystem and untangling what the terms, phrases and lore they threw around was about; parsing conversations. over time, i've honed a personal repositary of industry patterns, shifts and tools. now i can differentiate people who live 2 steps ahead, people who live current and people who are behind. most people are behind. they don't sense how the world is changing and changing rapidly.

as i started asking what it meant to be a builder, a creator and broadly a human with a 1000 passionate ideas in today's world, this newsletter — *paradigms* — emerged. in this, i discuss the emerging paradigms in the ai era, and the movements and strides thought leaders and early adopters in this space are enabling.

## On agentic coding & agent-native products
...
enter january, things changed up a bit. we went from vibe coding to agentic coding. from writing prompts and sticthing up parts → creating systems and pipelines for code to be created, reviewed, pushed and tested. being technical moved up the ladder from writing code to creating systems and software factories.
...
## On art, aesthetics and meaning making
...
the new skills needed are managerial. prioritization: what do you invest time in, what do you run parallely, what do you kill. making judgement calls on what is good, what is good enough and when you need one over the other.
...
## Superhumans: fluidity

with all this discussion, one meta topic deserves attention. what kind of a human survives this new era? what does it mean to be a succesful human? we've already touched upon some skills and traits at each level, but there's one higher-level trait i want to highlight here.
...
1. they won't hold on to one professional identity: they can be artists, researchers, builders, investors
2. they are a collection of tools: tools to explore, build and evaluate. given a new domain, they can research the space and create context for themselves; they can teach themselves to build artifacts that are appropriate for the space; they can manage data to evaluate mastery and direction to grow. learning > knowledge.
3. they do the above by building systems and parallel orchestration patterns
4. the biggest fundamental skill will be understanding patterns, finding cross-domain insights, reasoning and making judgement calls. sensemaking > knowledge
