...
- 2026-05-06 human cluster op: moved 1 page → `paradigms` (concepts/agent-native-office)
- 2026-05-06 human cluster op: moved 1 page → `agentic-coding` (concepts/agent-native-office)
