...
The catalog of all wiki pages, grouped by category and cluster. The LLM librarian maintains this file as part of every ingest. Cluster definitions live in `wiki/clusters.yml`; this index mirrors them.

## Concepts

### Agentic Coding

How software gets built when AI agents are first-class — Claude Code patterns, compound workflows, folder-as-agent, and the librarian division of labor.
...
Where durable advantage collects when the model layer commoditizes — boundaries with reality, distribution through trust, composable ecosystems that integrate but can't be replaced.
...
- [[concepts/social-dandelions]] — when code is commoditized and channels are saturated, sociology is the bottleneck; complex contagions, wide bridges, and the socially-active members who carry trust.
- [[concepts/super-porous-ecosystem]] — *(echoed)* the new competitive landscape where atoms are swappable.
