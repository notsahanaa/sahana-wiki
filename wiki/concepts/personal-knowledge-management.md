...
Andrej Karpathy articulates this most clearly in his {{source:karpathy-pkm-gist}}LLM-as-librarian gist{{/source}}: the human curates sources and asks questions; the LLM maintains the structure.
