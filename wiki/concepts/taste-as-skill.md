...
This includes [[people/kieran-klaassen]]'s observation that {{source:klaassen-folder-is-the-agent}}folder-agents capture *taste* — personality and aesthetic preferences{{/source}} alongside knowledge. Taste is becoming an *artifact* that gets stored, shared, and inherited by AI systems — not just a quality of an individual maker.
